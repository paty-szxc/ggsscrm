...
class ConstructionQuotationController extends Controller
{
    public function index(){
        $quotation = ConstructionQuotation::all();
    ...
    public function insert(Request $req){
        try{
            ...
            if($req->hasFile('attachment_file')){
                ...
                $attFilePath = $attFile->storeAs('pdfs/construction quotations', $origAttFileName, 'public');
            }
            ...
            $insert = ConstructionQuotation::create([
        ...
        try{
            $quotation = ConstructionQuotation::findOrfail($id);
